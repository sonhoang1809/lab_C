/* Script để viết lại các liên kết ngoài chỉ đến Wikibooks (và các dự án khác
 * của Wikimedia) để sử dụng máy chủ an toàn trong khi đã đang duyệt từ
 * https://vi.wikibooks.org, để cho các liên kết đến khác biệt v.v. không mang
 * bạn ra khỏi website.
